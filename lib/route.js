...
Router.prototype.resource = function(route, resource) {
  ...
  if(resource.list) this.get(route, function(req, res){project.list(req, res, this.db)});
  if(resource.create) this.post(route, function(req, res){project.create(req, res, this.db)});
  if(resource.read) this.get(route+'/:id', function(req, res){project.read(req, res, this.db)});
  if(resource.update) this.post(route+'/projects/:id', function(req, res){project.update(req, res, this.db)});
  if(resource.destroy) this.get(route+'/:id/destroy', function(req, res){project.destroy(req, res, this.db)});
