...
Router.prototype.resource = function(route, resource) {
  ...
  router.get(route, function(req, res){project.list(req, res, this.db)});
  router.post(route, function(req, res){project.create(req, res, this.db)});
  router.get(route+'/:id', function(req, res){project.read(req, res, this.db)});
  router.post(route+'/projects/:id', function(req, res){project.update(req, res, this.db)});
  router.get(route+'/:id/destroy', function(req, res){project.destroy(req, res, this.db)});
